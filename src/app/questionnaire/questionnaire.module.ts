...
import { IgxDropDownModule, IgxComboModule, IgxInputGroupModule, IgxToggleModule, IgxIconModule, IgxButtonModule, IgxAvatarModule } from 'igniteui-angular';
...
@NgModule({
    ...
    imports: [CommonModule, FormsModule, IgxDropDownModule, IgxComboModule,
        IgxInputGroupModule, IgxToggleModule, IgxIconModule, IgxButtonModule, IgxAvatarModule]
})
